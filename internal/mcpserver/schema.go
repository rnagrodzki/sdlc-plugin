...
// Ported from github.com/mark3labs/mcp-go@v1.0.0 (mcp/struct_schema.go),
// MIT License, Copyright (c) 2024 Anthropic, PBC. Preserves that package's
// jsonschema_description / jsonschema:"enum=..." struct tag conventions on
// top of github.com/google/jsonschema-go/jsonschema, so existing tool input
// structs need no changes after switching to the official MCP Go SDK.
...
// schemaFor generates a JSON schema for T, applying struct field tag
