...
Sub-flow of `/setup --plan-template`. Scaffolds a project-owned `.sdlc/plan-template.md`
...
mkdir -p .sdlc
cp "<PLUGIN_ROOT>/skills/plan/plan-template-default.md" .sdlc/plan-template.md
```
